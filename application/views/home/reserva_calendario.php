        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Calendário de reservas</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<script src="plugins/fullcalendar/calendario.js"></script>
    ...
    var calendar = new Calendar(calendarEl, {
      ...
      events    : [
         ...
         ?>
        {
          ...
          end            : new Date('<?=date( 'Y-m-d H:i', strtotime($reserva->fim) )?>'),
      ...
      if (!confirm("Deseja alterar esta aula?")) {
      info.revert();
      }
      }  
    });
